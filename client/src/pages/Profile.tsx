      ...
      <main className="max-w-4xl mx-auto px-4 py-8 pb-24 md:pb-8">
        ...
        <div className="mb-8 relative overflow-hidden rounded-2xl h-40 md:h-48 shadow-xl">
          ...
          <div className="relative z-10 h-full flex items-center p-8">
            <div>
              <h1 className="text-3xl md:text-4xl font-heading font-bold mb-2 flex items-center gap-2 text-white" data-testid="text-page-title">
                <UserIcon className="w-8 h-8" />
                My Profile
              </h1>
              <p className="text-white/80 text-lg">Complete your profile to help friends recognize you at reunions and events</p>
            </div>
          </div>
        </div>
