          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
            ...
            <Card 
              ...
              onClick={() => openEventDialog({
                ...
                icon: Cake,
                createPath: "/groups?type=birthday",
                joinPath: "/groups/join/",
            ...
            <Card 
              ...
              onClick={() => openEventDialog({
                ...
                icon: Gem,
                createPath: "/groups?type=wedding",
                joinPath: "/groups/join/",
            ...
            <Card 
              ...
              onClick={() => openEventDialog({
                ...
                icon: Baby,
                createPath: "/groups?type=baby_shower",
                joinPath: "/groups/join/",
